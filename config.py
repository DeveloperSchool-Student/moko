...
class Config:
    ...
    # Додаємо ціну за фейк
    FAKE_NEWS_COST = 100000.0
    # --- MARGIN & IPO ---
    MARGIN_MAX_LEVERAGE = 2.0  # Можна позичити 2x від власного капіталу (або 1:1 плече)
    MARGIN_MAINTENANCE_REQ = 0.3 # Margin Call якщо Equity < 30% від активів
    IPO_MIN_ENTRY = 1000.0       # Мінімальна сума для входу в IPO
    # Банк
    BANK_INTEREST_RATE = 0.05  # 5% річних
    DEPOSIT_MIN = 1000.0
    DEPOSIT_INTEREST_RATE = 0.10  # 10% за депозит
